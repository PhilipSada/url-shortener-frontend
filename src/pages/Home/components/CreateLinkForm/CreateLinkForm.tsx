...
import { SERVER_ENDPOINT, postApi } from '../../../../services/api/requestApi';
...
const CreateLinkForm: React.FC = () => {
    ...
    const handleSubmit = async (e: React.SyntheticEvent) => {
        ...
        const response = await postApi(SERVER_ENDPOINT+"shorten", formData);
        if (response.success) {
            // console.log(response.data)
            if(response.data.alias){
                generatedURL = SERVER_ENDPOINT + response.data.alias
            }else{
                generatedURL = SERVER_ENDPOINT + response.data.id
            }
